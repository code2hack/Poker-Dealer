...
public final class PokerPrototypeActivity extends Activity {
    private final Handler handler = new Handler(Looper.getMainLooper());
    private PokerTransportService service;
    ...
    private final ServiceConnection connection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName name, IBinder binder) {
            service = ((PokerTransportService.LocalBinder) binder).service();
            bound = true;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent transport = new Intent(this, PokerTransportService.class);
    ...
    private View buildUi() {
        ...
        title.setText("PROTOTYPE — glasses hotspot server");
        title.setTextSize(20);
        title.setTypeface(Typeface.DEFAULT_BOLD);
        content.addView(title);

        content.addView(button("Run 5,000 glasses probes", () -> {
            if (service != null) {
